 ...
 */
export type CaptureDetail = { shader_version_id: ShaderVersionId, status: CaptureStatus, error_message?: string, video_url?: string, avg_fps?: number, min_fps?: number, max_fps?: number, frame_time_avg?: number, frame_time_p99?: number, minecraft_version?: string, iris_version?: string, gpu_model?: string, content_type?: string, scene_version_id?: SceneVersionId, analysis?: CaptureAnalysis, created_at: string, updated_at: string, same_shader_scene: Array<CaptureWithContext>, same_scene: Array<CaptureWithContext>, same_run: Array<CaptureWithContext>, id: CaptureId, scene_id: SceneId, shader_slug: string, shader_name: string, shader_version: string, profile_id?: ShaderVersionProfileId, 
/**
