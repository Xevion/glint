 ...
 */
export function extractErrorContext(logContent: string, pattern: RegExp): string {
 ...
 */
export function spawnMinecraft(options: MinecraftProcessOptions): MinecraftProcess {
	const defaultArgs = [
