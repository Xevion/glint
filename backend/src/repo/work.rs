    ...
    pub async fn get_work_items(
        ...
        let items = sqlx::query_as!(
            ...
            SELECT
                ...
                sp.time_of_day_ticks AS preset_time_of_day_ticks,
                sp.weather AS preset_weather,
                sp.weather_intensity AS preset_weather_intensity,
                sp.moon_phase AS preset_moon_phase,
                lsv.package_url,
                lsv.package_hash,
                lsv.package_size_bytes,
                lsv.minecraft_version AS scene_minecraft_version,
